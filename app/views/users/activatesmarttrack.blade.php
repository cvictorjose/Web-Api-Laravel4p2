                        ...
                        <form class="mws-form wzd-ajax" id="activatesmarttracking-form" action="php/wizard.php" method="post">
                            ...
                            <fieldset class="wizard-step mws-form-inline">
                                ...
                                @foreach($bags as $bag)
									...
									?>
                                    <div class="mws-panel-body <?php echo $activeclass;?>" id="bagdiv_<?php echo $bag->bag_id;?>">
                                           ...
                                           <ul class="mws-summary clearfix">
                                                ...
                                                <li class='clearfix' style="border-bottom:none">
                                                    ...
                                                    <span class="val">
                                                        <span class="text-nowrap">{{ $bag->name }}<br/><?php echo trans('userlistbags.color');?> : {{ $bag->color }}<br/><?php echo trans('userlistbags.brand');?> : {{ $bag->brand }}</span>
                                                        <span class="text-nowrap"> <input type="radio" name="bag_id" value="<?php echo $bag->bag_id;?>" <?php echo $activeclass;?>> </span>
                                                    </span>
                                                </li>
