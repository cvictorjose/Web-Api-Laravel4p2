<?php
    ...
    /*$body = "<div style=\"font-size: 16px;font-family: Helvetica,Arial, Verdana;\">
						...
						$body	.=	trans('frontend.regiterbag_email_des_1', array('name' => $name, 'page_mybags' => $page_mybags, 'style_link_azzuro' => $style_link_azzuro, 'page_lostfound' => $page_lostfound, 'sfb_iphone' => $sfb_iphone, 'link_blu' => $link_blu, 'sfb_android' => $sfb_android ));
	...
	$body	.=	trans('frontend.regiterbag_email_des_2', array('depport' => $airportslist[$bookingdetails['depport']], 'arrport' => $airportslist[$bookingdetails['arrport']], 'depdate' => date('d/m/Y',$bookingdetails['depdate']), 'arrdate' => date('d/m/Y',$bookingdetails['arrdate']), 'airline' => $airline, 'social_twitter' => $social_twitter, 'social_facebook' => $social_facebook ));
