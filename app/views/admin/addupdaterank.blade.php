            ...
            <div class="container">
					...
					<div class="content_wrap intro_bg">
						<div class="content clearfix">
							<div class="col100">
								...
								<h2><i class="icol32-money-bag"></i>{{ 'Add/Edit Ranks'}}</h2>
            	...
            	<!--Panel start -->
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-book"></i>Add/Edit Ranks</span>
                    </div>
                    <div class="mws-panel-body no-padding">
		                    @if(isset($rank))
							    {{ Form::model($rank, array('url' => array('admin/updaterank/{$rank->rank_id}'),'class'=>'mws-form', 'method' => 'post')) }}
							    {{ Form::hidden('rank_id',$rank->rank_id) }}
							@else
							    {{ Form::open(array('url' => array('admin/addrank'),'class'=>'mws-form')) }}
							@endif
